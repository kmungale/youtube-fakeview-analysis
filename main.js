...
app.get('/', function(req, res) {
    ...
    var check_ip_reputation =  'http://check.getipintel.net/check.php?ip=' + (req.headers['x-forwarded-for'] || '63.152.57.234') + '&contact=kaustubhmungale@yahoo.com&format=json';
    var location;
